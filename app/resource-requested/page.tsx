  ...
  return (
    <Section>
      <Container className="max-w-3xl text-center">
        ...
        <p className="mt-4 text-lg leading-8 text-slate-600">Use the resource hub to keep exploring research-use sourcing, supplier checks, COA workflows, packaging, labeling, fulfillment, and launch planning.</p>
