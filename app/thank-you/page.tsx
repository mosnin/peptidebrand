  ...
  return (
    <Section>
      <Container className="max-w-3xl text-center">
        ...
        <p className="mt-4 text-lg leading-8 text-slate-600">Our team will review your research-use sourcing, documentation, testing, packaging, or fulfillment needs and follow up with next steps.</p>
