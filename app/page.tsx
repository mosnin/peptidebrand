  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-slate-200 bg-mist">
        <Image src={brandAssets.heroScientists} alt="USA-based laboratory preparing research peptide vials for testing and quality verification" fill priority sizes="100vw" className="object-cover opacity-[0.08]" />
        ...
        <Container className="relative grid gap-12 py-20 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:py-28">
          <div>
            ...
            <p className="mt-8 max-w-3xl text-sm text-slate-500">All peptide-related planning on this site is for laboratory research-use-only supply chains, documentation, sourcing, packaging, and fulfillment operations.</p>
      ...
      <Section>
        <Container className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-3 font-display text-4xl font-bold text-navy sm:text-5xl">Sourcing shouldn&apos;t cost you anything until you&apos;re ready to buy.</h2>
      ...
      <Section className="bg-mist">
        <Container>
          <div className="max-w-3xl">
            <p className="text-sm font-bold uppercase tracking-[0.25em] text-blue">Services</p>
              ...
              <div key={group.title} className="rounded-3xl border border-slate-200 bg-white p-6 shadow-soft">
                ...
                <div className="mt-4 grid gap-3">
                  {group.links.map((link) => (
                    <Link key={link.href} href={link.href} className="block rounded-2xl bg-mist p-3 transition hover:bg-blue/10">
      ...
      <Section>
        <Container className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.25em] text-blue">Full brand creation</p>
            <h2 className="mt-3 font-display text-4xl font-bold text-navy sm:text-5xl">From &ldquo;your brand here&rdquo; to a shelf-ready catalog.</h2>
            <p className="mt-5 text-lg leading-8 text-slate-600">White label and private label programs include custom packaging, printed labels, lot codes, research-use-only disclaimers, and certificate of analysis access — built around USA-based manufacturing and 99%+ purity documentation.</p>
            <div className="mt-8 flex flex-wrap gap-3">
      ...
      <Section className="bg-mist">
        <Container className="grid gap-10 lg:grid-cols-2 lg:items-center">
          ...
          <div className="order-1 lg:order-2">
            <p className="text-sm font-bold uppercase tracking-[0.25em] text-blue">Quality you can verify</p>
      ...
      <Section>
        <Container>
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 font-display text-4xl font-bold text-navy sm:text-5xl">A free, guided path from first call to fulfillment.</h2>
          </div>
          <div className="mt-10">
      ...
      <section id="lead-capture" className="border-y border-slate-200 bg-mist py-16 sm:py-24">
        <Container className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-black text-navy sm:text-4xl">Tell us what you want to source, brand, or launch.</h2>
      ...
      <Section>
        <Container className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h2 className="mt-3 font-display text-4xl font-bold text-navy sm:text-5xl">Cold-chain-ready inventory from domestic manufacturers.</h2>
      ...
      <Section className="bg-mist">
        <Container className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <h2 className="mt-3 font-display text-4xl font-bold text-navy sm:text-5xl">Research peptide sourcing questions, answered plainly.</h2>
          </div>
