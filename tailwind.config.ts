...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        hero: 'radial-gradient(circle at 18% 18%, rgba(76,141,255,0.22), transparent 34%), radial-gradient(circle at 82% 0%, rgba(47,111,237,0.22), transparent 32%), linear-gradient(135deg, #07111f 0%, #030712 100%)',
      ...
      boxShadow: {
        ...
        glow: '0 24px 90px rgba(47, 111, 237, 0.28)',
